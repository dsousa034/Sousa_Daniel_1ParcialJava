...
public class GrafoImpl {
    public static void main(String[] args) {
        ...
        Puerto puerto3 = new Puerto("Paris");
        Puerto puerto4 = new Puerto("Valencia");
        ...
        aristas.add(new Arista(250, puerto2));
        aristas.add(new Arista(20, puerto3));
        aristas.add(new Arista(2, puerto4));
        puerto1.setAristas(aristas);


        List<Arista> aristas2 = new ArrayList<>();
        aristas2.add(new Arista(250, puerto1));
        aristas2.add(new Arista(2000, puerto3));
        aristas2.add(new Arista(5, puerto4));
        puerto2.setAristas(aristas2);


        List<Arista> aristas3 = new ArrayList<>();
        aristas3.add(new Arista(20, puerto1));
        aristas3.add(new Arista(2000, puerto2));
        aristas3.add(new Arista(800, puerto4));
        puerto3.setAristas(aristas3);


        List<Arista> aristas4 = new ArrayList<>();
        aristas4.add(new Arista(2, puerto1));
        aristas4.add(new Arista(5, puerto2));
        aristas4.add(new Arista(800, puerto3));
